...
class Display:
    ...
    def __init__(self, initial_board):
        ...
        self.canvas_list = []
        self.finish_img = tk.PhotoImage(file='syringe.png')
        self.player_img = tk.PhotoImage(file='nurse.png')
        self.corona_img = tk.PhotoImage(file="corona.png")
        self.mask_img = tk.PhotoImage(file='mask.png')
